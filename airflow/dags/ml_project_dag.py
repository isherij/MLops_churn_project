...
import sys
import os
from model_pipeline import load_model, prepare_data, train_model, save_model, evaluate_model, predict  # Your custom functions
...
def cleanup_task():
    import os
    os.system("rm -f model.joblib")  # Delete any saved model files
...
format_check_task >> test_task >> data_preparation_task >> model_training_task >> model_saving_task >> model_evaluation_task >> predict_task >> cleanup_task
