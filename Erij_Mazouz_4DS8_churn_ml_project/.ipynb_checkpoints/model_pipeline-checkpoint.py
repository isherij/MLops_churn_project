...
def train_model(x_train, y_train):
    ...
    with mlflow.start_run(run_name="Train_Run") as run:
        ...
        accuracy = gbm_model.score(x_train, y_train)  # You can also use accuracy_score if needed
...
def load_model():
    ...
    model_filename = "/home/erij/Erij_Mazouz_4DS8_churn_ml_project/artifacts/GBM_model.pkl"
...
def evaluate_model(model, X_test, y_test):
    ...
    with mlflow.start_run(run_name="Evaluate_Run") as run:  
        ...
        print("Accuracy score:", round(accuracy * 100, 2))  # Round the accuracy to 2 decimal places
